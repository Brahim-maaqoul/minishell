My apologies, if the shell doesn't have limitations then the information regarding limitations can be removed from the README file. The updated README file will look like this:
